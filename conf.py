...
BLOG_AUTHOR = "Dr. ZHOU, Yongzhuang"  # (translatable)
BLOG_TITLE = "Resolving the Microscopic World with Spatially Modulated Light"  # (translatable)
...
BLOG_EMAIL = "y.zhou@pm.me"
BLOG_DESCRIPTION = "空间光场调控赋能的微观粒子探测"  # (translatable)
...
THEME = "bootstrap4"#"hpstr"#"slidemenu"#"lanyon"#"canterville"#"libretto"#"hack"#"bootstrap3-jinja"#"bootblog4"
